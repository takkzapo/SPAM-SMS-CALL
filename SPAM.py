...
░▓█▒░██▓ ▓█   ▓██▒▒██░   ▓██░░██░   ▒██████▒▒▒██▒ ░  ░ ▓█   ▓██▒▒██▒   ░██▒
 ...
 ░  ░░ ░  ░   ▒      ░   ░ ░  ▒ ░   ░  ░  ░  ░░         ░   ▒   ░      ░                                                                                   
 ░  ░  ░      ░  ░         ░  ░           ░                 ░  ░       ░                              \n\n'''
        print(Colorate.Vertical(Colors.DynamicMIX((Col.light_blue, Col.light_gray)), Center.XCenter(title)) + Colorate.Vertical(Colors.DynamicMIX((Col.light_green, Col.light_purple)), Center.XCenter(banner)))
    ...
    def run(self):
        while True:
            self.banner()
            self.phone = input(self.format_input("!",f"|HANI SPAM| NHẬP SỐ ĐIỆN THOẠI CẦN SPAM  : "))
            if self.phone != '0782554949':
                if len(self.phone) == 10:
                    break
                print(self.format_print("!", "SỐ ĐIỆN THOẠI DƯỚI <10 SỐ XIN NHẬP LẠI !"))
            if self.phone == '0782554949':
                print(self.format_print("!", "SỐ ĐIỆN THOẠI ADMIN TUS ĐẸP TRAI SPAM CC"))
            time.sleep(3)
